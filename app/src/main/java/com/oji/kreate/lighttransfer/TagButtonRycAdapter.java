...
public abstract class TagButtonRycAdapter extends BaseRycAdapter {

    public TagButtonRycAdapter(ArrayList dataList) {
        super(dataList);
    }
    ...
    public DataViewHolder onCreateDataViewHolder(ViewGroup viewGroup) {
        View view = View.inflate(viewGroup.getContext(), R.layout.recycler_base_upload_tag, null);
...
//        i = i % getDataList().size();
    ...
    public class TagButtonHolder extends DataViewHolder {
        ...
        public TagButtonHolder(View itemView) {
            ...
            tag_btn = itemView.findViewById(R.id.recycler_but_tag_btn);
